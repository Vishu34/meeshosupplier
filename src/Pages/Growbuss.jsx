...
const Growbuss = () => {
  return (
    ...
    content3="through Meesho’s selling tools for suppliers"
    imgsrc="https://supplier.meesho.com/images/banner-5-p-800.png"

/>
      {/* <div className="row bg-info">
        <div className="col-md-6">
          <div className="aside mx-4">Grow Your Business with Meesho</div>
          <div className="aside1 mx-4">
            Sell your products online and reach
            <span className="sellprdt"> crores of customers</span> through
            Meesho’s selling tools for suppliers
          </div>
          <div className="mono mx-2">
            <div className="input">
        ...
        <div className="col-md-6">
          <div className="piwmc">
            <img
              src="https://supplier.meesho.com/images/banner-5-p-800.png"
              alt="shopping"
      ...
      <div className="row">
        ...
        <div className="regaccontent">
          <div className="regacc1">advertise your product</div>
          <div className="blockcontent">
            <div className="panel">how compaign works</div>
          </div>
          <div className="regacc">product recommendation</div>
          <div className="blockcontent">
            <div className="panel">recommendation</div>
            <div className="panel">increase sales</div>
          </div>
          <div className="regacc">price recommendation</div>
          <div className="regacc">quality Dashboard</div>
          <div className="regacc">next day dispatch program</div>
          <div className="blockcontent">
            <div className="panel">benefit of registering</div>
            <div className="panel">steps to register</div>
          </div>
        </div></div>
         <div className="col-md-8">
        <div className=" w-100">
          <div className="reghead1">advertise your product</div>
